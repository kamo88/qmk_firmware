...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    // Base
    [_BASE] = LAYOUT(
      KC_PGUP, KC_ESC, KC_1,  KC_2,  KC_3,  KC_4,  KC_5, KC_MINS,    KC_GRV,   KC_EQL, KC_6,  KC_7,  KC_8,    KC_9,   KC_0,    KC_BSPC,
      KC_PGDN,  KC_TAB,  KC_Q,  KC_W,  KC_E,  KC_R,  KC_T,  KC_LBRC,       KC_RBRC,  KC_Y,  KC_U,  KC_I,    KC_O,   KC_P,  KC_BSLS, KC_DEL,
